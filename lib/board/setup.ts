...
export const SIGNING_LINE_IDS: readonly string[] = SIGNING_LINES.map(
  (line) => line.id,
);
...
export const TOPIC_LIBRARY: readonly LibraryTopic[] = [
  { id: "TOP001", text: "Should a hot dog be called a sandwich (or taco)?", tier: "Practice", category: "warmup" },
  { id: "TOP002", text: "Should astrology be taken seriously as a way to understand ourselves or others?", tier: "Practice", category: "warmup" },
  { id: "TOP003", text: "Should student loan debt for community college degrees be forgiven?", tier: "Serious Stuff", category: "Fairness" },
  { id: "TOP004", text: "Should people be required to have health insurance?", tier: "Serious Stuff", category: "Fairness" },
  { id: "TOP005", text: "Should the death penalty be allowed for premeditated mass murder?", tier: "Serious Stuff", category: "Fairness" },
  { id: "TOP006", text: "Should the government grant special protections to union workers, like preventing workers who strike from being fired?", tier: "Serious Stuff", category: "Rights" },
  { id: "TOP007", text: "Should people without a criminal record be allowed to own military-grade automatic weapons?", tier: "Serious Stuff", category: "Rights" },
  { id: "TOP008", text: "Should sugary soda be taxed for its health effects, like cigarettes?", tier: "Serious Stuff", category: "Rights" },
  { id: "TOP009", text: "Should AI-generated content (e.g., news, art, music) be clearly labeled to consumers?", tier: "Serious Stuff", category: "Tech" },
  { id: "TOP010", text: "Should cryptocurrency be legal?", tier: "Serious Stuff", category: "Tech" },
  { id: "TOP011", text: "Should self-driving cars be allowed on public streets?", tier: "Serious Stuff", category: "Tech" },
  { id: "TOP012", text: "Should the SAT be eliminated due to concerns about fairness and bias against some groups of college applicants?", tier: "Tough", category: "School" },
  { id: "TOP013", text: "Should a researcher who argues that women have a genetic disadvantage in math be allowed to present their research on a college campus?", tier: "Tough", category: "School" },
  { id: "TOP014", text: "Should athletes be allowed to join high school sports teams based on their gender identity instead of their sex at birth?", tier: "Tough", category: "School" },
  { id: "TOP015", text: "Should individuals facing persecution or human rights abuses in foreign countries be allowed temporary asylum in the USA?", tier: "Tough", category: "USA" },
  { id: "TOP016", text: "Should someone who entered the USA without documentation 20 years ago be deported now, even if it breaks up a family?", tier: "Tough", category: "USA" },
  { id: "TOP017", text: "Should the USA abolish the Electoral College and elect a president by popular vote?", tier: "Tough", category: "USA" },
];
