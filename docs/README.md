...
regen_command: none
verified: 2026-08-26
notes: "Lives inside the point-taken-2026 game repo so contractors with GitHub access can read it without workspace access. Created 2026-08-26 under BIZ-T260826-06. The design/, roadmap/, and spec/ subfolders are pre-existing docs pending fold-in and archival."
---
